...
/**
 * Like {@link execCommand} but writes `stdinData` on the channel's stdin
 * immediately after exec succeeds, and closes stdin. Use for feeding a
 * secret (e.g. sudo password) that must not appear on the argv of the
 * remote command.
 */
